...
{
  DCMI_RegDef_t                  *Instance;           /*!< DCMI Register base address   */
...
/**
  ...
  * @retval None
  */
#define __HAL_DCMI_ENABLE(__HANDLE__)    ((__HANDLE__)->Instance->CR.reg |= DCMI_CR_ENABLE)
...
/**
  ...
  * @retval None
  */
#define __HAL_DCMI_DISABLE(__HANDLE__)   ((__HANDLE__)->Instance->CR.reg &= ~(DCMI_CR_ENABLE))
...
/**
  ...
  * @retval None
  */
#define __HAL_DCMI_CLEAR_FLAG(__HANDLE__, __FLAG__) ((__HANDLE__)->Instance->ICR.reg = (__FLAG__))
...
/**
  ...
  * @retval None
  */
#define __HAL_DCMI_ENABLE_IT(__HANDLE__, __INTERRUPT__) ((__HANDLE__)->Instance->IER.reg |= (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_DCMI_DISABLE_IT(__HANDLE__, __INTERRUPT__) ((__HANDLE__)->Instance->IER.reg &= ~(__INTERRUPT__))
