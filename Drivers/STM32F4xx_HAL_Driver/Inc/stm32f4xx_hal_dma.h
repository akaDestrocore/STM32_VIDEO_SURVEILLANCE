...
{
  DMA_Stream_RegDef_t         *Instance;                                                        /*!< Register base address                  */
...
/**
  ...
  */
#define __HAL_DMA_GET_FS(__HANDLE__)      (((__HANDLE__)->Instance->FCR.reg & (DMA_SxFCR_FS)))
...
/**
  ...
  * @retval None
  */
#define __HAL_DMA_ENABLE(__HANDLE__)      ((__HANDLE__)->Instance->CR.reg |=  DMA_SxCR_EN)
...
/**
  ...
  * @retval None
  */
#define __HAL_DMA_DISABLE(__HANDLE__)     ((__HANDLE__)->Instance->CR.reg &=  ~DMA_SxCR_EN)
...
(((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA2_Stream3)? (DMA2->HIFCR.reg = (__FLAG__)) :\
 ((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA1_Stream7)? (DMA2->LIFCR.reg = (__FLAG__)) :\
 ((uint32_t)((__HANDLE__)->Instance) > (uint32_t)DMA1_Stream3)? (DMA1->HIFCR.reg = (__FLAG__)) : (DMA1->LIFCR.reg = (__FLAG__)))
...
((__HANDLE__)->Instance->CR.reg |= (__INTERRUPT__)) : ((__HANDLE__)->Instance->FCR.reg |= (__INTERRUPT__)))
...
#define __HAL_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)  (((__INTERRUPT__) != DMA_IT_FE)? \
                                                        ((__HANDLE__)->Instance->CR.reg & (__INTERRUPT__)) : \
                                                        ((__HANDLE__)->Instance->FCR.reg & (__INTERRUPT__)))
