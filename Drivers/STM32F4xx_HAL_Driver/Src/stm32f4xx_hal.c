...
{
  return((DBGMCU->IDCODE.reg) & IDCODE_DEVID_MASK);
}
...
{
  SET_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_SLEEP);
}
...
{
  CLEAR_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_SLEEP);
}
...
{
  SET_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_STOP);
}
...
{
  CLEAR_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_STOP);
}
...
{
  SET_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_STANDBY);
}
...
{
  CLEAR_BIT(DBGMCU->CR.reg, DBGMCU_CR_DBG_STANDBY);
}
